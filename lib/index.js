...
class ServerlessFargateTasks {
  ...
  compileTasks() {
    ...
    const loggroup_name = options.logGroupName || `${this.service.service}-FargateTasksLogGroup`
    ...
    template['Resources']['FargateTasksLogGroup'] = {
      "Type" : "AWS::Logs::LogGroup",
       "Properties": {
         "LogGroupName": {"Fn::Sub": "${FargateTasksLogGroup}"},
         "Description": "fargate tasks log group"
       },
    }
